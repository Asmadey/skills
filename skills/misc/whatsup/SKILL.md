---
name: whatsup
description: Полнофункциональный двунаправленный WhatsApp MCP-сервер на базе протокола Baileys (linked-device без Meta Business API). Позволяет Claude/ИИ-агентам читать чаты, отправлять сообщения/файлы/реакции и получать входящие уведомления в реальном времени.
category: integration
source: https://github.com/sshh12/claude-plugins/tree/main/plugins/whatsup
version: 1.0.0
metadata:
  trigger: "Чтение, отправка или автоответы на сообщения WhatsApp, привязка аккаунта WhatsApp (pair_request, qr_request), управление чатами/контактами через MCP, обработка входящих событий канала WhatsApp."
  anti_trigger: "Telegram, Slack, Discord или другие мессенджеры без WhatsApp; задачи веб-верстки и UI-дизайна без интеграции мессенджера."
---
