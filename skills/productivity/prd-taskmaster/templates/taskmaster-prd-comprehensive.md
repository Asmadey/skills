...
03. [Goals & Success Metrics](#goals--success-metrics)
04. [User Stories](#user-stories)
05. [Functional Requirements](#functional-requirements)
06. [Non-Functional Requirements](#non-functional-requirements)
07. [Technical Considerations](#technical-considerations)
08. [Implementation Roadmap](#implementation-roadmap)
09. [Out of Scope](#out-of-scope)
...
1. **Twilio (SMS):**
   ...
   - Failure handling: If down, disable SMS 2FA temporarily
2. **[Service Name]:**
...
- Task 1.1: Create database schema (REQ-001)
  - Complexity: Small (3h)
  - Dependencies: None
  - Owner: Backend team
- Task 1.2: Implement 2FA secret generation (REQ-002)
  - Complexity: Small (2h)
  - Dependencies: Task 1.1
  - Owner: Backend team
- Task 1.3: Implement TOTP validation logic (REQ-003)
...
_This PRD is optimized for taskmaster AI task generation. All requirements include task breakdown hints, complexity estimates, and dependency mapping to enable effective automated task planning._
