---
name: hallmark
description: Anti-AI-slop дизайн-система и правила для создания UI/лендингов, аудита визуального стиля, редизайна и извлечения дизайн-ДНК без типичных LLM-паттернов.
category: framework
source: https://github.com/Nutlope/hallmark
version: 1.1.0
metadata:
  trigger: "Создание новых UI, лендингов, веб-страниц, фронтенд-дизайн с нуля, редизайн существующих интерфейсов, аудит кода на визуальные анти-паттерны (AI-slop), команды hallmark (audit, redesign, study)."
  anti_trigger: "Бэкенд-разработка, чисто логические серверные скрипты, базы данных, инфраструктурные задачи, написание документации без верстки/UI."
---
