...
description: Экспертный дизайн мобильных экранов, UX-потоков, онбордингов и компонентов в стиле ведущих приложений (Airbnb, Spotify, Revolut, Duolingo, Phantom).
category: framework
source: https://github.com/ceorkm/mobile-app-ui-design
version: 1.0.0
metadata:
  trigger: "Проектирование мобильных интерфейсов, дизайн экранов приложений (mobile UI/UX, mockups, wireframes), мобильная навигация, онбординг-флоу, mobile-first прототипы (React Native, Flutter, SwiftUI, Web Mobile), оптимизация thumb zone и правила 60/30/10."
  anti_trigger: "Десктопные веб-панели с высокой плотностью таблиц, серверная разработка, бэкенд API, базы данных."
---
