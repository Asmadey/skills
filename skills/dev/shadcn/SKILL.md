---
name: shadcn
description: Официальный скилл для управления компонентами, темами, пресетами и реестрами shadcn/ui. Охватывает установку через CLI (`npx shadcn@latest`), композицию UI, формы, правила стилизации Tailwind CSS и интеграцию пресетов.
category: framework
source: https://github.com/shadcn-ui/ui/tree/main/skills/shadcn
version: 2.0.0
metadata:
  trigger: "Работа с shadcn/ui, добавление/поиск/настройка компонентов shadcn (`npx shadcn@latest add ...`), инициализация shadcn в проекте (`shadcn init`), работа с `components.json`, использование пресетов (`--preset`), композиция UI элементов (карточки, модалки, таблицы, сайдбары, формы)."
  anti_trigger: "Бэкенд-разработка, логика баз данных, инфраструктурные конфигурации, проекты без React/Tailwind/shadcn."
---
