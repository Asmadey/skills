---
name: magic-ui
description: Коллекция анимированных React/Next.js UI-компонентов и эффектов на базе Tailwind CSS и Framer Motion/Motion через shadcn CLI registry.
category: framework
source: https://github.com/magicuidesign/magicui
version: 1.0.0
metadata:
  trigger: "Добавление или настройка компонентов Magic UI (marquee, globe, blur-fade, shiny-button, particles, animated-beam, magic-card), создание анимированных секций лендингов/приложений (hero, CTA, feature grid, testimonials), интеграция компонентов `@magicui/*` через shadcn CLI."
  anti_trigger: "Бэкенд-логика, не-React проекты, работа с базами данных, чисто текстовые задачи без интерактивного/анимированного UI."
---
