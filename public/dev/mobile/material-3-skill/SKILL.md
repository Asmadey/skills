---
name: material-3
description: Полная имплементация дизайн-системы Google Material Design 3 (Material You) и M3 Expressive для Jetpack Compose, Flutter и Web (адаптивные сетки, токены, 30+ компонентов, динамические цвета).
category: framework
source: https://github.com/hamen/material-3-skill
version: 1.2.0
metadata:
  trigger: "Внедрение Material Design 3, MD3, Material You, Jetpack Compose MaterialTheme, M3 Expressive, Material components (FAB, TopAppBar, NavigationBar, Cards, Chips, Dialogs), адаптивные Android/Flutter интерфейсы."
  anti_trigger: "iOS/Human Interface Guidelines (HIG) дизайн, стилизация в жестком Tailwind/shadcn стиле без токенов M3, разработка чисто серверной логики."
---
