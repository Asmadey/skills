...
description: Высокопроизводительный CLI-инструмент и прокси браузерной автоматизации для Claude/ИИ-агентов на базе Chrome DevTools Protocol (скриншоты, клики, дерево доступности, парсинг данных за логином, запись GIF, эмуляция устройств).
category: tooling
source: https://github.com/sshh12/claude-plugins/tree/main/plugins/brw
version: 1.0.0
metadata:
  trigger: "Автоматизация действий в браузере (Chrome/Chromium), тестирование веб-приложений, снятие скриншотов, заполнение веб-форм, парсинг закрытых страниц за авторизацией (`auth-tokens`, `script run`), управление вкладками, инспекция сетевых запросов через CDP."
  anti_trigger: "Прямые вызовы документированных REST/GraphQL API без необходимости открывать браузер, бэкенд-разработка, системное администрирование."
---
