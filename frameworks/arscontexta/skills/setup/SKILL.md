...
#*1.* ops/derivation.md (FIRST -- before any other file)
...
#*8.* Templates with _schema blocks
...
#*9.* Skills (vocabulary-transformed, full suite)
...
#*12.* Semantic Search Setup (conditional)
...
#*13.* Graph Query Scripts (derived from template schemas)
...
Note: Restart Claude Code now to activate skills and hooks.
