...
The Agentic OS организует знания агентов по строгой иерархии:
...
| Навык | Назначение и возможности | Стек / Формат |
| :--- | :--- | :--- |
| [**`skill-creator`**](skills/skill-ops/skill-creator/SKILL.md) | **Skill Engineering Engine**. Создание навыков с нуля, адаптация git-репозиториев, валидация L1-L3 и упаковка навыков The Agentic OS. | Python / CLI |
...
Помимо модульных навыков, в The Agentic OS интегрированы полномасштабные фреймворки разработки:
...
claude plugin marketplace add /path/to/The Agentic OS/skills
```
...
Все агенты в среде The Agentic OS подчиняются обязательным правилам:
